...
public class InputKeyboard1 {
    public static void main (String [] args) {
        ...
        int jd = Integer.valueOf(jumData).intValue();
        ...
        for (int i = 0; i < jd; i++) {
            ...
            try {
                ...
                double gP = Double.valueOf(gajiPokok[i]).doubleValue();
                double jL = Double.valueOf(jumlahLembur[i]).doubleValue();
                double uL = Double.valueOf(upahLembur[i]).doubleValue();
